...
<div class="admin__container-slider__navbar__content">
    <div class="admin__container-slider__navbar__content-form">
        ...
        <div class="admin__container-slider__navbar__content-form-wrap">
          <form action="{{ route('category.post-update') }}" method="post" class="admin__form">
            <span class="admin__container-slider__navbar__content-form__text">Tên danh mục </span>
            <input type="text" name="category_name" id="" placeholder="Nhập tên ở đây" value="{{old('category_name') ?? $category->category_name }}" class="admin__container-slider__navbar__content-form__input">
            @error('category_name')
