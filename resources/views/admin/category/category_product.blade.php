    ...
    <div class="admin__container-slider__navbar__content-form">
        ...
        <div class="admin__container-slider__navbar__content-form-wrap">
          <form action="" method="post" class="admin__form">
            ...
            <input type="text" name="category_product_name" value="{{ old('category_product_name')}}"id="" placeholder="Nhập tên ở đây" class="admin__container-slider__navbar__content-form__input">
            ...
            <select name="category_local_id" id="cars" class="admin__container-product__add-form__select">
              <option value="">Danh mục hãng</option>
